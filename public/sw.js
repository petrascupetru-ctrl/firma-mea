// Debt Manager Pro — service worker (offline runtime caching)
const CACHE = "dmp-cache-v1";
...
// Network-first for navigations (fresh app), cache-first fallback for assets.
